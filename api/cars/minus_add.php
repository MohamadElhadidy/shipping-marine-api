...
<body>
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading">إضافة خصم على سيارة نقل </div>
            <div class="panel-body text-center justify-content-center">
                <form id="myform">
                    ...
                    <div id="element">
                        ...
                        <input type="text" id="cause" placeholder="سبب الخصم" name="cause">
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.confirm({
                        ...
                        content: ' للسيارة رقم ' + data.car_no,
                        type: 'green',
                        rtl: true,
                        closeIcon: false,
                        draggable: true,
