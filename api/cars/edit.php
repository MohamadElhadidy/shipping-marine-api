...
<head>
    <title> تعديل بيانات السيارات</title>
...
<body>
    <div class="container" id="container">
        <div class="panel panel-default">
            <div class="panel-heading">تعديل بيانات السيارات</div>
...
$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                html += '<table><tr><td>  اسم الباخرة : ' + data.vessel.name +
                    '</td><td>  الرصيف :  ' + data.vessel.quay + '</td><td> نوع الصنف :  ' + data
    ...
    $(document).on('change', '#vessels', function() {
        ...
        $('#table').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': '../controllers/load_cars_edit.php',
                'data': {
                    "vessel_id": vessel_id
                },
            },
