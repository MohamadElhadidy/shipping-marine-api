...
$id =$_GET['id'];
$result = mysqli_query($con,"SELECT *  FROM loading   where  id =  $id ");
...
<head>
    <title>تعديل كارتة التحميل </title>
...
<body>
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading">تعديل كارتة التحميل</div>
            <div class="panel-body text-center justify-content-center">
                <form id="myform">
                    ...
                    <select id="store_no" class='width'>
                        <option value="<?php echo $row['store_no'] ;?>" disabled><?php echo $row['store_no'] ;?></option>
                    </select>
                    <select id="type" class='width' >
                        <option value="<?php echo $row['type'] ;?>"disabled ><?php echo $row['type'] ;?></option>
                    </select>

                    <p>اسم الموظف</p>
                    <input type="text" id="ename"  disabled name="ename" class="text" value="<?php echo $row['ename'];?>">
                    <p>ملاحظات</p>
                    <input type="text" class="text" disabled id="notes" name="notes" value="<?php echo $row['notes'];?>">
...
$("#btn-save").click(function(e) {
    $("#myform").validate({
        ...
        submitHandler: function() {
            ...
            $.ajax({
                type: "POST",
                url: '../controllers/loading_update.php',
                data: formData,
                dataType: "json",
                encode: true,
