...
<head>
    <title> تعديل كارتة الشحن على الرصيف</title>
...
<body>
    <div class="container" id="container">
        <div class="panel panel-default">
            <div class="panel-heading">تعديل كارتة الشحن على الرصيف</div>
        ...
        <table id="table">
            <thead>
                <tr>
                    ...
                    <th>رقم العنبر </th>
                    <th>رقم السير </th>
                    <th> رقم الحلة الأولى </th>
                    <th>رقم الحلة الثانيه</th>
                    <th>رقم الكباش </th>
                    <th>رقم الونش </th>
                    <th>اسم الموظف</th>
                    <th>ملاحظات</th>
...
$(document).ready(function() {
    ...
    $(document).on('change', '#vessels', function() {
        ...
        $('#table').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': '../controllers/load_arrival_edit.php',
                'data': {
                    "vessel_id": vessel_id
                },
            },
